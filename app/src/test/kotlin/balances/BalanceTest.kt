...
class BalanceTest {
    ...
    @Test
    fun `token with 4 relevant decimals and balance 0,0 should be 0,0000`() =
        assertRounded(4.0, 0.0, "0.0000")

    @Test
    fun `token with 18 relevant decimals and balance 0,0 should be 0,0000`() =
        assertRounded(18.0, 0.0, "0.${"0".repeat(18)}")
